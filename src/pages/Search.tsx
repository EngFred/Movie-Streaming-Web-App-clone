...
const Search: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-netflix-dark text-white">
      <div className="container mx-auto pt-20 pb-16 px-4 sm:px-6 md:px-8">
        <motion.h2
        ...
        {/* Search Type Buttons */}
        <div className="flex space-x-3 sm:space-x-4 mb-10">
          <motion.button
        ...
        {((searchType === 'movies' || searchType === 'all') && !isInitialLoading) && (
          ...
          >
            <h3 className="text-3xl sm:text-4xl font-bold mb-6 text-white">Movies</h3>
            {movieQuery.error ? (
            ...
            ) : movieItems.length === 0 && !movieQuery.isLoading ? (
